...
export interface ILinkedUsersService extends Omit<ILinkedUsersRepository, 'getLinkedUsersByCustomersIdAsync' | 'createLinkedUsersTemporaryAsync' | 'createLinkedUsersAsync' | 'deleteLinkedUsersTemporaryAsync' | 'deleteLinkedUsersAsync'> {
    createLinkedUsersTemporaryAsync(linkedUsers: LinkedUsersDto): Promise<void>;
    createLinkedUsersAsync(linkedUsers: LinkedUsersDto): Promise<void>;
