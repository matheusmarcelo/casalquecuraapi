...
__decorate([
    (0, class_validator_1.IsString)({ message: 'The receiver id must be string type' }),
    (0, class_validator_1.IsNotEmpty)({ message: 'The receiver id must have a value' }),
    __metadata("design:type", String)
], LinkedUsersDto.prototype, "toId", void 0);
